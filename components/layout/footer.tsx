  ...
  return (
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <div className="footer-contact"><h3>Contact</h3><p><Phone /> +91 00000 00000 <em>Replace with official number</em></p><p><Mail /> hello@example.com <em>Replace with official email</em></p></div>
